...
from quant.services.graphs.graph_builders import GraphBuildResult, GraphEdge
...
def persist_graph_snapshot(
    ...
    """Write graph artifacts and persist a shared Quant GraphSnapshot.
    ...
    return GraphSnapshot.objects.create(
        name=name,
        component_name="quant_graph_lab",
        config_json=config,
