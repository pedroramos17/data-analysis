"""Graph filtering priors for Quant graph validation."""

from __future__ import annotations

from collections.abc import Sequence

from quant.services.graphs.graph_builders import GraphEdge
...
class PMFGFilter:
    ...
    def filter_edges(self, edges: Sequence[GraphEdge]) -> list[GraphEdge]:
        ...
        raise OptionalDependencyMissingError(
            "Component 'pmfg' requires optional dependency 'quant_pmfg'; "
...
class TMFGFilter:
    ...
    def filter_edges(self, edges: Sequence[GraphEdge]) -> list[GraphEdge]:
        ...
        raise OptionalDependencyMissingError(
            "Component 'tmfg' requires optional dependency 'quant_tmfg'; "
            "expected installed module"
        )
...
class RandomMatrixFilteredCovariance:
    ...
    def filter_covariance(
        ...
        raise OptionalDependencyMissingError(
            ...
            "dependency 'quant_rmt'; expected installed module"
        )
