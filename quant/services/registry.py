"""Name-based component registry for Quant research services."""
...
class ComponentSpec:
    """Declarative registry entry for a Quant component.
...
def _default_specs() -> list[ComponentSpec]:
    return [
        ComponentSpec("baseline", "models", dict, "QUANT_MODEL_BASELINE"),
        ComponentSpec("variance", "risk_models", dict, "QUANT_RISK_MODELS"),
        ComponentSpec("correlation", "graph_builders", dict, "QUANT_GRAPH_BUILDERS"),
        ComponentSpec("mean_variance", "optimizers", dict, "QUANT_OPTIMIZERS"),
        ComponentSpec("walk_forward", "shufflers", dict, "QUANT_SHUFFLERS"),
        ComponentSpec("identity", "denoisers", dict, "QUANT_DENOISERS"),
        ComponentSpec(
            "threshold",
            "regime_detectors",
            dict,
            "QUANT_REGIME_DETECTORS",
        ),
    ]
