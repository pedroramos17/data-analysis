"""Production MF-DFA implementation for Quant multifractal analysis."""
...
from quant.services.multifractal.core.detrending import detrended_variance
from quant.services.multifractal.core.scaling import (
    build_scaling_diagnostic,
    default_scale_grid,
)
from quant.services.multifractal.core.spectrum import (
