...
from quant.services.regimes.detectors import regime_summary
from quant.services.registry import stable_config_hash
from quant.services.risk.covariance import ewma_volatility, historical_volatility
from quant.services.risk.liquidity_risk import estimate_liquidity_risk
from quant.services.risk.risk_attribution import (
    build_model_risk_fields,
    build_risk_sections,
)
from quant.services.risk.tail_risk import (
    drawdown_duration,
    expected_shortfall,
    historical_var,
    max_drawdown,
...
def run_risk_analysis(
    ...
    """Persist a separated Quant risk report in RiskRun.metrics_json.
