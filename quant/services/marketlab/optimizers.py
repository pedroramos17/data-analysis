...
from quant.services.marketlab.interfaces import BaseOptimizerFactory
from sourceflow.config.feature_flags import require_feature

LOCAL_OPTIMIZERS = frozenset({"Adam", "AdamW", "AdaGrad"})
OPTIONAL_FLAGS = {
    "Lion": "QUANT_MARKETLAB_OPTIMIZER_LION",
    "Sophia": "QUANT_MARKETLAB_OPTIMIZER_SOPHIA",
    "Muon": "QUANT_MARKETLAB_OPTIMIZER_MUON",
    "SpecMuon": "QUANT_MARKETLAB_OPTIMIZER_SPECMUON",
}
