"""Quant multifractal Phase 5 method tests."""
...
class QuantAdditionalMultifractalMethodTests(SimpleTestCase):
    ...
    def test_mfdma_modes_return_common_summary_interface(self) -> None:
        ...
        from quant.services.multifractal.core.mfdma import run_mfdma
    ...
    def test_mfdcca_outputs_joint_metrics_without_future_windows(self) -> None:
        ...
        from quant.services.multifractal.core.mfdcca import run_mfdcca
    ...
    def test_partition_function_requires_positive_measure(self) -> None:
        ...
        from quant.services.multifractal.core.partition import run_partition_function
    ...
    def test_wavelet_diagnostics_use_optional_backend_or_local_fallback(self) -> None:
        ...
        from quant.services.multifractal.core.wavelet import run_wavelet_diagnostics
