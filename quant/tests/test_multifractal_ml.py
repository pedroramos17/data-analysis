"""Quant multifractal Phase 12 ML integration tests."""
...
class QuantMultifractalMLTests(SimpleTestCase):
    ...
    def test_supervised_dataset_uses_horizon_targets(self) -> None:
        ...
        from quant.services.multifractal.ml.datasets import build_supervised_dataset
    ...
    def test_walk_forward_split_has_purge_gap(self) -> None:
        ...
        from quant.services.multifractal.ml.datasets import build_walk_forward_splits
    ...
    def test_walk_forward_evaluation_does_not_claim_performance(self) -> None:
        ...
        from quant.services.multifractal.ml.datasets import build_supervised_dataset
        from quant.services.multifractal.ml.evaluation import evaluate_walk_forward
