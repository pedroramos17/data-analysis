"""Quant registry-first core tests."""
...
class QuantAssetRegistryTests(TestCase):
...
class QuantArtifactTests(TestCase):
    ...
    def test_window_artifacts_store_split_metadata(self) -> None:
        ...
        from quant.services.data_ingestion import save_market_dataset_metadata
        from quant.services.windows import create_window_artifact
    ...
    def test_run_models_expose_reproducibility_fields(self) -> None:
        """All Quant run records keep hash, seed, ranges, and provenance."""
...
class QuantSafetyTests(TestCase):
    ...
    def test_leakage_checker_rejects_future_feature_timestamps(self) -> None:
        ...
        from quant.services.leakage import assert_no_future_feature_timestamps
    ...
    def test_registry_can_enable_disable_components(self) -> None:
        ...
        registry.register(
            ComponentSpec(
                ...
                category="models",
                factory=dict,
                feature_flag="QUANT_MODEL_BASELINE",
            )
        )
    ...
    def test_missing_optional_component_returns_clear_error(self) -> None:
        ...
        registry.register(
            ComponentSpec(
                ...
                category="denoisers",
                factory=dict,
                required_import="missing_quant_optional_dependency",
            )
        )

        with self.assertRaisesRegex(
            OptionalDependencyMissingError,
            "missing_quant_optional_dependency",
        ):
