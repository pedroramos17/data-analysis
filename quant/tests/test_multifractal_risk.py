"""Quant multifractal Phase 8 risk tests."""
...
class QuantMultifractalRiskTests(SimpleTestCase):
    ...
    def test_var_output_is_monotonic_with_confidence_level(self) -> None:
        ...
        from quant.services.multifractal.risk.var import historical_var
    ...
    def test_var_and_expected_shortfall_are_zero_without_losses(self) -> None:
        ...
        from quant.services.multifractal.risk.var import (
            expected_shortfall,
            historical_var,
        )
    ...
    def test_expected_shortfall_averages_losses_beyond_var(self) -> None:
        ...
        from quant.services.multifractal.risk.var import expected_shortfall
    ...
    def test_risk_report_has_separate_sections_and_caution(self) -> None:
        ...
        from quant.services.multifractal.risk.reports import build_risk_report
