"""Quant multifractal Phase 15 quality-gate tests."""
...
class QuantMultifractalQualityGateTests(SimpleTestCase):
    ...
    def test_quality_gate_matrix_has_required_commands(self) -> None:
        ...
        from quant.services.multifractal.quality_gates import quality_gate_matrix
        ...
        self.assertTrue(any("manage.py test quant" in command for command in commands))
    ...
    def test_integration_smoke_runs_across_modules(self) -> None:
        ...
        from quant.services.multifractal.quality_gates import run_integration_smoke
    ...
    def test_shared_defaults_and_regime_helper_are_used_by_modules(self) -> None:
        ...
        import quant.services.multifractal.quality_gates as quality_gates
        import quant.services.multifractal.reports.multifractal_report as reports
        from quant.services.multifractal.defaults import DEFAULT_DIAGNOSTIC_SEED
        from quant.services.multifractal.regime.features import (
