"""MarketLab services under Quant shared models."""
...
class MarketLabWindowTests(TestCase):
    ...
    def test_no_future_leakage_in_windows(self) -> None:
        ...
        from quant.services.marketlab.windows import PurgedWalkForwardWindowBuilder
    ...
    def test_shuffle_applies_only_to_train_split(self) -> None:
        ...
        from quant.services.marketlab.shuffling import GeneralizedTimeWindowShuffle
        from quant.services.marketlab.windows import MarketWindow
    ...
    def test_temporal_patch_shuffle_preserves_shape(self) -> None:
        ...
        from quant.services.marketlab.shuffling import TemporalPatchShuffle
        from quant.services.marketlab.windows import MarketWindow
    ...
    def test_overlap_shuffle_preserves_index_metadata(self) -> None:
        ...
        from quant.services.marketlab.shuffling import OverlapWindowShuffle
        from quant.services.marketlab.windows import MarketWindow
    ...
    def test_marketlab_window_artifacts_use_shared_quant_model(self) -> None:
        """Window persistence uses the shared Quant WindowArtifact table."""
        from quant.models import WindowArtifact
        from quant.services.marketlab.windows import (
            MarketWindow,
...
class MarketLabTopologyTests(TestCase):
    ...
    def test_topology_aware_shuffle_rejects_high_loss_candidate(self) -> None:
        ...
        from quant.services.marketlab.shuffling import TopologyAwareShuffle
        from quant.services.marketlab.windows import MarketWindow
    ...
    def test_imf_reconstruction_error_checked_when_decomposition_exists(self) -> None:
        ...
        from quant.services.marketlab.decomposition import IMFDecomposer
...
class MarketLabModelTests(TestCase):
    """MarketLab should persist through shared Quant run models."""
    ...
    def test_graph_snapshots_use_only_past_data(self) -> None:
        ...
        from quant.services.marketlab.graph_builders import CorrelationGraphBuilder
    ...
    def test_timegan_synthetic_data_never_used_in_validation_or_test(self) -> None:
        ...
        from quant.services.marketlab.datasets import build_train_only_synthetic_rows
    ...
    def test_optimizer_factory_returns_valid_optimizer(self) -> None:
        ...
        from quant.services.marketlab.optimizers import OptimizerFactory
    ...
    def test_benchmark_outputs_required_metrics(self) -> None:
        ...
        from quant.models import ModelRun
