"""Quant multifractal Phase 9 regime tests."""
...
class QuantMultifractalRegimeTests(SimpleTestCase):
    ...
    def test_shared_regime_feature_rows_match_cli_helper(self) -> None:
        ...
        from quant.services.multifractal.cli_support import regime_feature_rows
