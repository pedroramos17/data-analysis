"""Quant graph and topology lab tests."""
...
class QuantGraphBuilderTests(TestCase):
    ...
    def test_graph_edges_use_only_window_data_up_to_window_end(self) -> None:
        ...
        from quant.services.graphs.graph_builders import CorrelationGraphBuilder
    ...
    def test_graph_snapshot_writes_node_edge_and_adjacency_paths(self) -> None:
        ...
        from quant.services.graphs.graph_builders import CorrelationGraphBuilder
        from quant.services.graphs.graph_sampling import persist_graph_snapshot
    ...
    @override_settings(
        SOURCEFLOW_FEATURE_FLAGS={"QUANT_SOURCEFLOW_KNOWLEDGE_GRAPH": False}
    )
    def test_sourceflow_knowledge_graph_builder_is_behind_feature_flag(self) -> None:
        ...
        from quant.services.graphs.graph_builders import NewsKnowledgeGraphBuilder
    ...
    def test_quant_build_graphs_command_persists_snapshot_paths(self) -> None:
...
class QuantTopologyTests(TestCase):
    ...
    def test_optional_graph_dependencies_fail_clearly(self) -> None:
        ...
        from quant.services.graphs.graph_filters import PMFGFilter
