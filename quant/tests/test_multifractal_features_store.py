"""Quant multifractal Phase 7 feature engineering tests."""
...
class QuantMultifractalFeatureEngineeringTests(TestCase):
    ...
    def test_core_feature_row_contains_required_metrics(self) -> None:
        ...
        from quant.services.multifractal.features.multifractal_features import (
    ...
    def test_feature_store_writes_parquet_and_registers_artifact(self) -> None:
        ...
        from quant.models import FeatureArtifact
        from quant.services.multifractal.features.feature_store import (
