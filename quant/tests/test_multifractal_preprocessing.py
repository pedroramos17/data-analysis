"""Quant multifractal Phase 2 preprocessing tests."""
...
class QuantMultifractalReturnPreprocessingTests(SimpleTestCase):
    ...
    def test_return_transforms_are_numerically_correct(self) -> None:
        ...
        from quant.services.multifractal.preprocessing.returns import (
...
class QuantMultifractalWindowPreprocessingTests(SimpleTestCase):
    ...
    def test_sliding_windows_do_not_leak_future_data(self) -> None:
        ...
        from quant.services.multifractal.preprocessing.windows import sliding_windows
    ...
    def test_expanding_and_anchored_walk_forward_windows_are_ordered(self) -> None:
        ...
        from quant.services.multifractal.preprocessing.windows import (
...
class QuantMultifractalOutlierPreprocessingTests(SimpleTestCase):
    ...
    def test_winsorization_flags_without_default_deletion(self) -> None:
        ...
        from quant.services.multifractal.preprocessing.outliers import (
...
class QuantMultifractalSurrogatePreprocessingTests(SimpleTestCase):
