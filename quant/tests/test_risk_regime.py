"""Quant MVP2 risk and regime tests."""
...
class QuantRegimeCoreTests(TestCase):
    ...
    def test_regime_labels_use_only_past_training_data(self) -> None:
        ...
        from quant.services.regimes.detectors import rolling_volatility_regime
    ...
    def test_optional_ruptures_detector_fails_clearly(self) -> None:
        ...
        from quant.services.regimes.optional import detect_ruptures_regime
...
class QuantRiskCoreTests(TestCase):
    ...
    def test_risk_run_stores_metrics_json(self) -> None:
        ...
        from quant.models import RiskRun
        from quant.services.risk.reports import run_risk_analysis
    ...
    def test_stress_report_stores_scenario_outputs(self) -> None:
        ...
        from quant.services.risk.stress_testing import build_stress_report
    ...
    def test_liquidity_risk_works_without_lob_data_using_fallback(self) -> None:
        ...
        from quant.services.risk.liquidity_risk import estimate_liquidity_risk
    ...
    def test_model_risk_fields_exist_but_do_not_overclaim_causality(self) -> None:
        ...
        from quant.services.risk.risk_attribution import build_model_risk_fields
