"""Quant multifractal Phase 6 model tests."""
...
class QuantMultifractalResearchModelTests(SimpleTestCase):
    ...
    def test_msm_simulation_is_seeded_and_shapes_are_stable(self) -> None:
        ...
        from quant.services.multifractal.models.msm import (
            MSMParameters,
    ...
    def test_msm_parameters_validate_inputs(self) -> None:
        ...
        from quant.services.multifractal.models.msm import MSMParameters
    ...
    def test_mmar_simulation_and_calibration_placeholder_are_explicit(self) -> None:
        ...
        from quant.services.multifractal.models.mmar import (
            MMARParameters,
    ...
    def test_mrw_simulation_and_intermittency_estimate_are_seeded(self) -> None:
        ...
        from quant.services.multifractal.models.mrw import (
            MRWParameters,
