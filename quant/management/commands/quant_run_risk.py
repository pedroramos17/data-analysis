...
class Command(BaseCommand):
    """Persist a Quant risk run."""

    help = "Run Quant local risk models on JSON returns, prices, and volumes."

    def add_arguments(self, parser: CommandParser) -> None:
        """Register risk run options."""
        parser.add_argument("--name", default="quant-risk-run")
    ...
    def handle(self, *args: object, **options: object) -> None:
        ...
        run = run_risk_analysis(
            ...
            provenance={"command": "quant_run_risk"},
        )
