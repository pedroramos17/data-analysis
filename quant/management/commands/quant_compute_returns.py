"""Compute return Parquet datasets from Quant multifractal bars."""
...
from quant.services.multifractal.data.validators import generate_return_records


class Command(BaseCommand):
    """Compute adjacent returns from local bar datasets."""

    help = "Compute Quant multifractal return records from local Parquet bars."
