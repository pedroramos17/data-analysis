"""Canonical command for evaluating symbolic factor values."""
...
class Command(BaseCommand):
    ...
    def handle(self, *args: object, **options: object) -> None:
        ...
        Example:
            `python manage.py evaluate_factors --factor coverage_intensity`
        """
        ...
        self.stdout.write(f"Evaluated {len(rows)} factor rows")
