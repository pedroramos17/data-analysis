"""SQLite metadata models for the ResearchSpace research cockpit."""

from __future__ import annotations

from django.db import models

from researchspace.services.status import support_status_choices
...
class Paper(models.Model):
    ...
    pdf_file = models.FileField(upload_to="researchspace/papers/", blank=True)
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="uniq_researchspace_paper_chunk",
            )
        ]
