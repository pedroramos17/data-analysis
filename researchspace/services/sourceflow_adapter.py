"""Adapter from ResearchSpace candidates to Sourceflow formula JSON."""
...
def can_adapt_factor_candidate(candidate: SourceflowAdapterCandidate) -> bool:
    """Return whether a ResearchSpace factor can cross the Sourceflow boundary.
...
def _adapter_metadata(
    ...
    return {
        "adapter": "researchspace.sourceflow_formula_json",
        "adapter_boundary": "non_persistent",
        "paper_id": candidate.paper_id,
        "researchspace_factor_candidate_id": candidate.pk,
