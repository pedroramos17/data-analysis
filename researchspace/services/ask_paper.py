...
from researchspace.services.evidence import (
...
def answer_paper_question(
    ...
    """
    require_feature("RESEARCHSPACE_CORE")
...
def _configured_llm_provider() -> str:
    if not feature_flag_enabled("RESEARCHSPACE_LLM_PROVIDER"):
        return ""
    return str(getattr(settings, "RESEARCHSPACE_LLM_PROVIDER", "")).strip()
...
def _record_question(
    ...
    from researchspace.models import PaperQuestion
