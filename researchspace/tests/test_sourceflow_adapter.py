"""Tests for the ResearchSpace to Sourceflow symbolic formula adapter."""
...
class SourceflowAdapterTests(TestCase):
    ...
    def test_simple_unary_formula_adapts(self) -> None:
        ...
        from researchspace.services.sourceflow_adapter import (
...
def limitations_text(candidate: FactorCandidate) -> str:
    ...
    from researchspace.services.sourceflow_adapter import explain_adapter_limitations
