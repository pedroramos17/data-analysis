"""Export ResearchSpace chunks to Parquet."""
...
from researchspace.services.chunk_export import export_paper_chunks_to_parquet


class Command(BaseCommand):
    """Export one paper's chunks to Parquet."""

    help = "Export ResearchSpace paper chunks to Parquet."
