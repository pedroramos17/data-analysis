...
QuantSpace is the local-first research cockpit for papers. It stores PDF
...
- `/quantspace/papers/<id>/`
- `/quantspace/papers/<id>/ask/`
- `/quantspace/papers/<id>/extract/`
...
python manage.py export_quantspace_parquet --paper-id 1
```
