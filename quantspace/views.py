"""Views for the QuantSpace local research cockpit."""
...
from quantspace.forms import ExtractionForm, PaperQuestionForm, PaperUploadForm
from quantspace.models import FactorCandidate, Paper
from quantspace.services.ask_paper import answer_paper_question
from quantspace.services.factor_prompting import generate_factor_candidates
...
class PaperListView(ListView):
    ...
    model = Paper
    paginate_by = 50
    template_name = "quantspace/paper_list.html"
...
class PaperDetailView(DetailView):
    ...
    model = Paper
    template_name = "quantspace/paper_detail.html"
...
class FactorLabView(ListView):
    ...
    paginate_by = 50
    template_name = "quantspace/factor_lab.html"
...
def paper_upload_view(request: HttpRequest) -> HttpResponse:
    ...
    if request.method == "POST" and form.is_valid():
        ...
        return redirect("quantspace:paper-detail", pk=result.paper.pk)
    return render(request, "quantspace/paper_upload.html", {"form": form})
