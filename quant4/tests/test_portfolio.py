"""Quant4 portfolio optimization MVP tests."""
...
class Quant4PortfolioOptimizerTests(TestCase):
    ...
    def test_weights_sum_to_expected_budget(self) -> None:
        ...
        from quant4.services.portfolio.optimizers import (
            EqualWeightOptimizer,
            MinimumVarianceOptimizer,
        )
        from quant4.services.risk.covariance import covariance_shrinkage
    ...
    def test_constraints_are_respected(self) -> None:
        ...
        from quant4.services.portfolio.constraints import PortfolioConstraints
        from quant4.services.portfolio.optimizers import MaxSharpePrototypeOptimizer
    ...
    def test_liquidity_constraint_can_reject_infeasible_portfolio(self) -> None:
        ...
        from quant4.services.portfolio.constraints import (
    ...
    def test_transaction_cost_drag_is_calculated(self) -> None:
        ...
        from quant4.services.portfolio.transaction_costs import (
...
class Quant4PortfolioPersistenceTests(TestCase):
    ...
    def test_portfolio_run_stores_paths_metrics_and_risk_report(self) -> None:
        ...
        from quant4.models import PortfolioRun

        with TemporaryDirectory() as output_dir:
            call_command(
                "quant4_optimize_portfolio",
                "--name",
                "portfolio-smoke",
                "--symbols",
                "AAA,BBB",
...
class Quant4PortfolioOptionalBackendTests(TestCase):
    ...
    def test_optional_portfolio_backends_fail_clearly(self) -> None:
        ...
        from quant4.services.portfolio.cvxpy_backend import CVaROptimizer
        from quant4.services.portfolio.pyportfolioopt_backend import (
            PyPortfolioOptOptimizer,
        )
        from quant4.services.portfolio.riskfolio_backend import RiskfolioOptimizer
        ...
        with self.assertRaisesRegex(OptionalDependencyMissingError, "cvxpy"):
            CVaROptimizer(required_module="missing_quant4_cvxpy").optimize()
        with self.assertRaisesRegex(OptionalDependencyMissingError, "riskfolio"):
            RiskfolioOptimizer(required_module="missing_quant4_riskfolio").optimize()
        with self.assertRaisesRegex(OptionalDependencyMissingError, "pyportfolioopt"):
            PyPortfolioOptOptimizer(
                required_module="missing_quant4_pyportfolioopt"
            ).optimize()
