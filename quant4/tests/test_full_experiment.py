"""Quant4 safe full-experiment orchestrator tests."""
...
class Quant4FullExperimentCommandTests(TestCase):
    ...
    def test_dry_run_prints_dag(self) -> None:
        ...
        experiment = Experiment.objects.get(name="global_macro_quant4_v1")
