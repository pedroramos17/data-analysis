"""Quant4 multifractal Phase 4 diagnostics tests."""
...
class Quant4MultifractalDiagnosticTests(SimpleTestCase):
    ...
    def test_finite_size_report_warns_on_short_samples(self) -> None:
        ...
        from quant4.services.multifractal.core.stat_tests import run_finite_size_check
    ...
    def test_diagnostics_report_is_json_serializable_and_markdown_ready(self) -> None:
        ...
        from quant4.services.multifractal.core.diagnostics import (
