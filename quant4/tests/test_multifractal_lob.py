"""Quant4 multifractal Phase 11 LOB readiness tests."""
...
class Quant4MultifractalLOBTests(SimpleTestCase):
    ...
    def test_lob_feature_placeholders_use_observed_book_only(self) -> None:
        ...
        from quant4.services.multifractal.lob.features import build_lob_mf_features
