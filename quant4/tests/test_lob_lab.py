"""Quant4 LOB and microstructure lab tests."""
...
class Quant4LOBFeatureTests(TestCase):
    ...
    def test_lob_features_never_include_future_book_states(self) -> None:
        ...
        from quant4.services.lob.normalizer import normalize_lob_rows
    ...
    def test_feature_tensors_preserve_time_order(self) -> None:
        ...
        from quant4.services.lob.normalizer import normalize_lob_rows
        from quant4.services.lob.orderbook_features import build_feature_tensor
...
class Quant4LOBModelTests(TestCase):
    ...
    def test_baseline_model_runs_without_pytorch(self) -> None:
        ...
        from quant4.services.lob.deeplob import NaiveImbalanceBaseline
    ...
    def test_optional_lob_models_fail_clearly_without_pytorch(self) -> None:
        ...
        from quant4.services.lob.deeplob import DeepLOBModel, TCNLOBModel
