"""Quant4 multifractal Phase 1 data contract tests."""
...
class Quant4MultifractalDataContractTests(TestCase):
    ...
    def test_csv_to_parquet_roundtrip(self) -> None:
        ...
        from quant4.services.multifractal.data.validators import import_ohlcv_csv
    ...
    def test_returns_generation_correctness(self) -> None:
        ...
        from quant4.services.multifractal.data.validators import (
    ...
    def test_registry_dataset_id_is_deterministic(self) -> None:
        ...
        from quant4.services.multifractal.data.sqlite_registry import (
            build_dataset_id,
        ...
        dataset = register_multifractal_dataset(
            dataset_id=left,
            kind="bars",
            artifact_root="data/quant4_multifractal/bars",
            metadata=metadata,
            row_count=3,
        )
...
def _bar_records() -> list[object]:
    from quant4.services.multifractal.data.contracts import OHLCVBar
