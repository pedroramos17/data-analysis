"""Run Quant4 local portfolio optimizers."""
...
class Command(BaseCommand):
    """Persist a Quant4 portfolio optimization run."""

    help = "Run local Quant4 portfolio optimization and persist a PortfolioRun."

    def add_arguments(self, parser: CommandParser) -> None:
        """Register portfolio optimizer options."""
        parser.add_argument("--name", default="quant4-portfolio-run")
        ...
        parser.add_argument("--output-dir", default="data/quant4_portfolios")
