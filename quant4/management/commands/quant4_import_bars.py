"""Import OHLCV CSV bars for Quant4 multifractal analysis."""
...
from quant4.services.multifractal.data.parquet_store import write_bars_parquet
...
class Command(BaseCommand):
    ...
    help = "Import local OHLCV CSV bars into Quant4 multifractal Parquet storage."
