"""Train local Quant4 LOB baselines."""
...
from quant4.services.lob.lob_backtest import train_lob_baseline_run
...
class Command(BaseCommand):
    ...
    help = "Train a local Quant4 LOB baseline and persist an LOBRun."

    def add_arguments(self, parser: CommandParser) -> None:
        """Register LOB model training options."""
        parser.add_argument("--name", default="quant4-lob-run")
