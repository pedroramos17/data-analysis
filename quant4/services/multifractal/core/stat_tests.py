"""Statistical diagnostics for Quant4 MF-DFA outputs."""
...
from quant4.services.multifractal.core.types import MFDFAConfig, MFDFAResult
from quant4.services.multifractal.preprocessing.outliers import winsorize_values
