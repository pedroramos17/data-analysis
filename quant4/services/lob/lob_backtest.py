...
from quant4.services.lob.deeplob import (
    LogisticRegressionBaseline,
    NaiveImbalanceBaseline,
)
from quant4.services.lob.microstructure_labels import LOBLabelRow, build_lob_labels
from quant4.services.lob.orderbook_features import (
    OrderBookFeatureRow,
    build_orderbook_features,
)
from quant4.services.lob.parser import LOBSnapshot, parse_lob_jsonl
...
def _persist_lob_run(
    ...
    config = {"engine": "quant4_lob", "model": model_name, "horizon": horizon}
    return LOBRun.objects.create(
        name=name,
        component_name="quant4_lob",
        config_json=config,
