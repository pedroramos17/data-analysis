...
def optimize_portfolio(
    ...
    """
    require_feature("QUANT4_PORTFOLIO_CORE")
    ...
    raise ValueError(
        ...
        "expected supported Quant4 portfolio optimizer"
    )
...
def persist_portfolio_run(
    ...
    config = {"engine": "quant4_portfolio", "optimizer": result.metadata["optimizer"]}
    return PortfolioRun.objects.create(
        name=name,
        component_name="quant4_portfolio",
        config_json=config,
